...
class MeetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meeting" do
    assert_difference('Meeting.count') do
      post meetings_url, params: { meeting: { name: @meeting.name, session_id: @meeting.session_id } }
    end
  ...
  test "should update meeting" do
    patch meeting_url(@meeting), params: { meeting: { name: @meeting.name, session_id: @meeting.session_id } }
